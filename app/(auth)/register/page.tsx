...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* Right form panel */}
      <div
        className="flex-1 flex items-center justify-center p-6 sm:p-8 lg:p-12 bg-background relative overflow-hidden"
      >
        {/* Subtle mobile gradient accent */}
        <div
        ...
        >
          ...
          <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
            <CardHeader className="text-center pb-2">
              ...
              <CardDescription>
                Comienza tu experiencia con Cigüeña
              </CardDescription>
            </CardHeader>
